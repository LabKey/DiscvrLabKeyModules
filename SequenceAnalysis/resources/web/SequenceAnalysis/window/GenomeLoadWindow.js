Ext4.define('SequenceAnalysis.window.GenomeLoadWindow', {
    ...
    initComponent: function(){
        ...
        Ext4.apply(this, {
            ...
            items: [{
                html: 'This will load a reference genome from NCBI\'s FTP site, which is <a style="font-weight: bold;" href="ftp://ftp.ncbi.nlm.nih.gov/genomes/README.txt" target="_blank" rel="noopener noreferrer">described here</a>.<br><br>' +
                        'You need to supply the name of the genome directory to load.  To view available directories, <a style="font-weight: bold;" href="ftp://ftp.ncbi.nlm.nih.gov/genomes/" target="_blank" rel="noopener noreferrer">click here</a>.<br><br>' +

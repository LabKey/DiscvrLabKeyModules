                ...
                listeners: {
                    change: function (field, val) {
                        ...
                        if (val.format == 'advanced') {
                            target.add([{
                                html: 'This option allows you to enter an advanced expression to create the FASTA header line.  These expressions use the same syntax as <a href="' + LABKEY.Utils.getHelpTopicHref('urlEncoding') + '" target="_blank" rel="noopener noreferrer">LabKey\'s column URL expressions</a>.  These allow you to substitute the value of any field into the header by enclosing it with ${}, such as: "${rowid}_${name}_${species}".',

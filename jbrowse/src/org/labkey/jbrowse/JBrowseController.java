...
public class JBrowseController extends SpringActionController
{
    ...
    public static class ModifyAttributesAction extends MutatingApiAction<SimpleApiJsonForm>
    {
        ...
        {
            org.json.old.JSONArray jsonFiles = form.getJsonObject().getJSONArray("jsonFiles");
            ...
            org.json.old.JSONObject attributes = form.getJsonObject().getJSONObject("attributes");
